          ...
          .map((todo, index) => (
            <li key={index}>
              <motion.div
                ...
                className="group m-3 my-5 flex flex-row items-center justify-between gap-3 rounded-lg border-b border-secondary bg-neutral-50 p-3 pr-6 shadow-sm shadow-secondary transition-all duration-300 ease-in-out hover:cursor-grab hover:border-accent active:cursor-grabbing"
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="line-clamp-1 whitespace-nowrap font-Outfit text-lg font-medium tracking-wide text-primary line-through transition-all duration-500 first-letter:uppercase hover:line-clamp-3 hover:cursor-grab active:cursor-grabbing group-hover:font-semibold group-hover:text-accent peer-hover:font-bold peer-hover:tracking-widest">
                    {todo.task}
                  </div>
                </div>
